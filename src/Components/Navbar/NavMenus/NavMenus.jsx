...
const NavMenus = () => {
  return (
    <div className="text-slate-100">
      <Link to="">
        <div className="mb-3 px-6 py-3 bg-[#1A0061] font-bold rounded-lg flex items-center gap-4 duration-1000 hover:bg-[#3500D4] hover:duration-1000 hover:cursor-pointer">
