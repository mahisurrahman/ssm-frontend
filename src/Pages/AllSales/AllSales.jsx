        ...
        {prodDetails && (
          <div className="flex justify-between items-center">
            ...
            <div className="mt-5 text-xl text-slate-950 pl-10 leading-9">
              <h2 className="font-extrabold">Name: <span className="font-normal">{prodDetails.productName}</span></h2>
              <h2 className="font-extrabold">Description: <span className="font-normal">{prodDetails.description}</span></h2>
              <h2 className="font-extrabold">Buying Price: <span className="font-normal">{prodDetails.price}$</span></h2>
              <h2 className="font-extrabold">Selling Price: <span className="font-normal">{stockDetais.stockQuantity}</span></h2>
              <h2 className="font-extrabold">Profit: <span className="font-normal">{stockDetais.stockQuantity}</span></h2>
              <h2 className="font-extrabold">Loss: <span className="font-normal">{stockDetais.stockQuantity}</span></h2>
              <h2 className="font-extrabold">Creation Date: <span className="font-normal">{prodDetails.createDate}</span></h2>
              <h2 className="font-extrabold">Stock Remaining: <span className="font-normal">{stockDetais.stockQuantity}</span></h2>
              <h2 className="font-extrabold">Is Active: <span className="font-normal">{stockDetais.stockQuantity}</span></h2>
            </div>
          </div>
        )}
